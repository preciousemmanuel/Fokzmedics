...
@section('content')
      ...
      <form action="{{route('diagnostic.update-profile',$user->id)}}" method="POST" enctype="multipart/form-data">
      	@method('PUT')
      	@csrf
    ...
    <div class="box_general padding_bottom">
      <div class="header_box version_2">
        <h2><i class="fa fa-file"></i>Lab Info</h2>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input type="text" required class="form-control" name="business_name" value="{{$user->business_name}}" placeholder="Lab Name">
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input type="text" required class="form-control" name="consult_hour" value="{{$user->consult_hour}}" placeholder="">
          </div>
        </div>
    ...
    <!-- /box_general-->
		...
		<div class="box_general padding_bottom">
			<div class="header_box version_2">
				<h2><i class="fa fa-map-marker"></i>Lab Address</h2>
			</div>
