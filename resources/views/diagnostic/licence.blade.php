...
<div class="container-fluid">
      ...
      <ol class="breadcrumb">
		...
		<div class="box_general padding_bottom">
			...
			<div class="row">		
				<div class="col-md-12">
					 <form method="post" action="{{route('diagnostic.upload-licence',$user->id)}}" enctype="multipart/form-data" 
        ...
        Dropzone.options.dropzone =
         {
            ...
            removedfile: function(file) 
            {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: '{{ route("diagnostic.delete-licence",$user->id) }}',
                    data: {filename: name},
