...
<div class="container-fluid">
    ...
    <div class="box_general">
      <div class="header_box">
        <h2 class="d-inline-block">Diagnostic</h2> 
        
      </div>
      <div class="list_general">
         <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for diagnostic's name..">
      ...
      <tbody>
        @foreach($diagnostics as $pharmacy)
        <tr>
          <td>
    ...
    <!-- end modal -->
       ...
       {{$diagnostics->appends(['search'=>request()->query('search')])->links()}}
