...
<div class="container-fluid">
    ...
    <div class="box_general">
      <div class="header_box">
        <h2 class="d-inline-block">Pharmacy</h2> 
        
      </div>
      <div class="list_general">
         <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for pharmacy's name..">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <p>Supretendent Registration Number : {{$pharmacy->licence_number}}</p>
          <p>Supretendent name : {{$pharmacy->supretendent_name}}</p>
          <p>Referal : {{empty($pharmacy->referal)?'No referal':$pharmacy->referal}}</p>
            <p>Office Address : {{$pharmacy->address}}</p>
    ...
    <!-- end modal -->
       ...
       {{$pharmacys->appends(['specialization'=>request()->query('specialization'),'search'=>request()->query('search')])->links()}}
