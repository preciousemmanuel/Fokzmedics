      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltips" data-placement="right" title="Dashboard">
         ...
         <li class="nav-item" data-toggle="tooltips" data-placement="right" title="inventory">
          <a class="nav-link" href="{{route('pharmacy.drugTransaction')}}">
            <i class="fa fa-fw fa-money"></i>
            <span class="nav-link-text">Transactions</span>
          </a>
        </li>
         <li class="nav-item" data-toggle="tooltips" data-placement="right" title="inventory">
          <a class="nav-link" href="{{route('pharmacy.centralDrug')}}">
            <i class="fa fa-fw fa-cubes"></i>
            <span class="nav-link-text">Central Drug Inventory</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltips" data-placement="right" title="My profile">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseProfile" data-parent="#exampleAccordion">
            <i class="fa fa-fw fa-wrench"></i>
            <span class="nav-link-text">Manage Drugs</span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapseProfile">
            <li>
              <a href="{{route('pharmacy.drugs')}}">Add Drugs</a>
            </li>
        ...
        <li class="nav-item" data-toggle="tooltips" data-placement="right" title="Profile">
          <a class="nav-link" href="{{route('pharmacy.licence')}}">
        ...
        <li class="nav-item" data-toggle="tooltips" data-placement="right" title="Profile">
          <a class="nav-link" href="{{route('pharmacy.profile')}}">
