...
@section('content')
      ...
      <form action="{{route('pharmacy.update-profile',$user->id)}}" method="POST" enctype="multipart/form-data">
      	@method('PUT')
      	@csrf
    ...
    <div class="box_general padding_bottom">
      <div class="header_box version_2">
        <h2><i class="fa fa-file"></i>Pharmacy Info</h2>
       
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            <label>Pharm. Name</label>
            <input type="text" required class="form-control" name="business_name" value="{{$user->business_name}}" placeholder="Pharmacy Name">
          </div>
        </div>
      ...
      <!-- /row-->
       ...
       <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label>Supretendent Registration Number</label>
            <input type="text" required class="form-control" name="licence_number" value="{{$user->licence_number}}" placeholder="Supretendent licence number">
          </div>
        </div>
        <div class="col-md-6">
              <div class="form-group">
                <label>Supretendent name</label>
                <input type="text"  required class="form-control" name="supretendent_name" value="{{$user->supretendent_name}}" placeholder="Please fill your email address ">
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            <label>Working Hours<small>Update working hours(24/7) or input time eg: 8am -6pm</small></label>

            <input type="text" required class="form-control" name="consult_hour" value="{{$user->consult_hour}}" placeholder="Working hours">
          </div>
        </div>
    ...
    <!-- /box_general-->
		...
		<div class="box_general padding_bottom">
			<div class="header_box version_2">
				<h2><i class="fa fa-map-marker"></i>Pharmacy Address</h2>
			</div>
