			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-4">
					...
					<ul class="links">
						...
						<li><a href="faq-doctors">FAQs for Doctors</a></li>
					
						<li><a href="faq-freelance">FAQs For Freelance Pharmacist</a></li>
...
s1.async=true;
s1.src='https://embed.tawk.to/5a34eb5cf4461b0b4ef89135/default';
s1.charset='UTF-8';
